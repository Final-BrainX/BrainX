                  ...
                  >
                    ...
                    <div className={cx("grid transition-all duration-300 ease-out", expanded ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0")}>
                      <div className="overflow-hidden">
                        <div className="border-t border-line/40 bg-surface2/30 px-3 py-3">
                          <div className="scroll max-h-[100px] space-y-2 overflow-y-auto text-[12px] leading-relaxed text-txt3">
                            <p className="break-keep">{document.summary}</p>
                            {document.sections.map((section) => (
                              <div key={section.title}>
                                <p className="mb-0.5 text-[11.5px] font-semibold text-txt2">{section.title}</p>
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="mt-2.5 inline-flex items-center gap-1.5 rounded-lg border border-line/60 bg-surface px-2.5 py-1.5 text-[11.5px] font-medium text-txt2 transition-colors hover:border-primary/50 hover:text-primary"
                          >
