...
| `AiSuggestionDecisionRecorded` | `brainx.knowledge.intelligence.ai-suggestion-decision-recorded.v1` | 노트 작성 보조 | 제안 수락/거절/재생성 결정을 suggestion projection, 후속 Workspace 반영 흐름, 사용성 지표에 반영한다. |
