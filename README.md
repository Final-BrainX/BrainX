...
Intelligence semantic search는 낮은 유사도 결과 노출을 줄이기 위해 `brainx.semantic-search.min-score` 기본값 `0.35`를 적용합니다. 운영에서는 `BRAINX_SEMANTIC_SEARCH_MIN_SCORE`로 `0.0`부터 `1.0` 사이에서 조정할 수 있습니다.
